...
public class VariableValue {
    ...
    public String toString() {
        ...
        sb.append(VariableValue.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("firstName");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VariableValue) == false) {
            return false;
        }
        VariableValue rhs = ((VariableValue) other);
